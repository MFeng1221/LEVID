...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='0721_FixtimeGreenRoute_Newyork_0.01')
    ...
    parser.add_argument("--volume", type=str, default='newyork')#'300'u
    parser.add_argument("--ratio", type=str, default='real_triple')#'0.3_uni'
    parser.add_argument("--model", type=str, default="FixedtimeGreen")#'Fixedtime','MaxPressure','FixedtimeGreen','MaxPressureGreen'
    ...
    parser.add_argument("--route_planning",type=int, default=2) #0-none，1-proposed，2-baseline
